...
**Version:** 0.0.1-dev
**Active branch:** eature/ESPCAMFW-38-native-pio-env

---

## Current State

Infrastructure components merged to main: sys_log, 
vs_config,
pp_event, power_manager. Test infrastructure (Unity host tests) in place.
...
- **[ESPCAMFW-13]** ✅ 
vs_config component — NVS-backed key/value config store,
  typed getters/setters, default values, Unity host tests
- **[ESPCAMFW-14]** ✅ pp_event component — centralized FreeRTOS event loop,
...
- **[ESPCAMFW-35]** ✅ Test infrastructure — Unity 2.6.0 vendored, mock headers,
  	est/Makefile, CI 	est job parallel to uild
...
- **[ESPCAMFW-??]** oards/ structure — board-header files per target,
  multi-env platformio.ini (LilyGo T-Display S3, AI Thinker ESP32-CAM,
  Olimex ESP32-POE); prerequisite for camera_driver and wifi_manager
- **[ESPCAMFW-??]** Extend 
vs_config with 
etwork_mode field
  (wifi / ethernet / both) — prerequisite for wifi_manager
- **[ESPCAMFW-??]** wifi_manager component — connect, reconnect, NVS credential
  storage; conditional compile on boards without WiFi
- **[ESPCAMFW-??]** camera_driver component — DVP HAL, PSRAM frame buffer pool,
  OV2640 and OV5640 sensor support
- **[ESPCAMFW-??]** tsp_server component — RTSP/RTP stack, RFC 2435 MJPEG packetiser
